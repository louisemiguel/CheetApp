...
public class CheatSheetProvider extends ContentProvider {
    ...
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/cheatsheet");

    // MIME types used for searching words or looking up a single definition
    public static final String WORDS_MIME_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE +
                                                  "/vnd.cheatsheet.cheet";
    public static final String DEFINITION_MIME_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE +
                                                       "/vnd.cheatsheet.cheet";

    private CheatSheetDatabase mCheatSheet;
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        // to get definitions...
        matcher.addURI(AUTHORITY, "cheatsheet", SEARCH_WORDS);
        matcher.addURI(AUTHORITY, "cheatsheet/#", GET_WORD);
        // to get suggestions...
    ...
    public boolean onCreate() {
        mCheatSheet = new CheatSheetDatabase(getContext());
        return true;
    }
    ...
    private Cursor getSuggestions(String query) {
      ...
      String[] columns = new String[] {
          BaseColumns._ID,
          CheatSheetDatabase.KEY_TAG,
          CheatSheetDatabase.KEY_DEFINITION,
       /* SearchManager.SUGGEST_COLUMN_SHORTCUT_ID,
                        (only if you want to refresh shortcuts) */
          SearchManager.SUGGEST_COLUMN_INTENT_DATA_ID};

      return mCheatSheet.getTagMatches(query, columns);
    }
